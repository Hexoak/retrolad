...
//CREATE SCENE
   ...
   document.body.appendChild(renderer.domElement);;
    ...
    var gradient = textureLoader.load('./assets/gradient.gif')
        scene.background = gradient;


//BUILD SCENE
    //Create Ground Plane
    var planeTexture = textureLoader.load ("./assets/plane.gif");
...
//SWORD OBJECT
        var swordTexture = textureLoader.load ("./assets/sword2.gif");
...
//TREE1
    ...
    function createCylinder(x, y, z) {
        const cylinderTexture = textureLoader.load('./assets/wood.gif');
...
const texturesFirstCircle = [
    textureLoader.load('./assets/tree1 copy.gif'),
    textureLoader.load('./assets/tree2.gif'),
    textureLoader.load('./assets/tree3.gif')
];
const texturesSecondCircle = [
    textureLoader.load('./assets/tree1.gif'),
    textureLoader.load('./assets/tree2.gif'),
    textureLoader.load('./assets/tree3.gif')
];
...
//GRASS TEST
const grassTextures = [
    textureLoader.load('./assets/grass1.gif'),
    textureLoader.load('./assets/grass2.gif'),
    textureLoader.load('./assets/grass3.gif'),
    textureLoader.load('./assets/grass4.gif'),
    textureLoader.load('./assets/grass5.gif')
];
...
const rockTextures = [
    textureLoader.load('./assets/rock1.gif'),
    textureLoader.load('./assets/rock2.gif'),
    textureLoader.load('./assets/rock3.gif')
];
...
//CAMERA
      ...
      //const controls = new THREE.OrbitControls(camera, renderer.domElement);
       ...
       var cameraOffset = new THREE.Vector3(-.02, .5, 2.8); // Offset of the camera from the playerObject
