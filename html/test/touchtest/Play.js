class Play extends Phaser.Scene {
    ...
    create() {
      ...
      //text
      this.inputText = this.add.text(window.innerWidth/2, window.innerHeight/4, '', { fontSize: '12px', fill: '#fff' });
      this.inputText.setOrigin(0.5);
      this.inputText.setText('Touch The Screen');
      this.distanceText = this.add.text(10,10, '', { fontSize: '12px', fill: '#fff' });
